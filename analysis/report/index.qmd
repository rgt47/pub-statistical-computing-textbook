...
![A workflow scene showing a simple diagram of the two books' structure: seven parts in the methods volume, seven parts in the practicum, each containing the same chapter template.](media/images/ambiance3.png){.img-fluid}
...
[x] document-type: 'blog', draft: true
